...
# This script is meant to record a short video of the partial phase, for later stacking.
...
echo "Configuring camera parameters! (detailed timings follow)"
time gphoto2 --port $sony_port \
        ...
        --set-config-value '/main/capturesettings/shutterspeed=1/800'
echo
...
echo
# It's 19 and not 20 because we already slept for 1 second beforehand.
sleep 19
